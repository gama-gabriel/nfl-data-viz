...
export default function Menu() {
  ...
  const gridView = useInView(gridRef);
  ...
  return (
    <>
      ...
      <div className="pb-20" ref={gridRef}>
        <h2 className="w-fit h-fit mx-auto py-20 text-4xl font-bold">
          Features
        </h2>

        <motion.div
          className="flex mx-auto px-10 w-full gap-3 h-56 justify-center 2xl:w-full"
      ...
      <div className="flex flex-col justify-center items-center py-20">
        <h2 className="text-4xl font-bold py-2" ref={gridRef}>
          Getting started
        </h2>
      ...
      <div className="flex justify-center  gap-5 items-center ">
        <MotionLink
          ...
          whileHover="hover"
        >
          <p className="font-bold text-xl pb-1">General</p>
          <motion.p
