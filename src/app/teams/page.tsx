...
function Menu() {
  ...
  return (
    <>
    <section className='before:pointer-events-none before:fixed before:inset-0 before:z-0 before:bg-[radial-gradient(circle_farthest-side_at_var(--x,_300px)_var(--y,_500px),_var(--color-secondary)_0%,_transparent_90%)] before:opacity-30'>
    <div className='flex p-4 h-fit max-w-[56rem] z-10 mx-auto my-12 bg-black' >
    <Suspense fallback={<Skeleton className='w-max h-max rounded-md bg-neutral-900'/>}>
        <ScatterGraph lista={lista} />
      </Suspense>
      
    </div>
    <a href='/players' className=' bg-red-900 z-10'>
        Texto 
      </a>
      <a href='/' className=' bg-red-900 z-10'>
        Texto 
      </a>
    </section>
    </>
